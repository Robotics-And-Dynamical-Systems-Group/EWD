            ...
            ZStack{
                ...
                VStack(spacing: 10){
                    ZStack(alignment:.center){
                        ...
                        }.position(x: screenSize.width/1.60, y: screenSize.height/30)}
                        LineView(data: TopGraphData, title: TopGraphTitle, style: selectedGraphStyle)
                            .frame(width: screenSize.width/1.2, height: screenSize.height*0.03)
                    ...
                    ZStack{
                        LineView(data: EKGGraphData, title: EKGGraphTitle, style: selectedGraphStyle)
                            .frame(width: screenSize.width/1.2, height: screenSize.height/3, alignment: .center)
