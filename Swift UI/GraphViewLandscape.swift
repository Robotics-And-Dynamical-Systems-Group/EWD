...
struct GraphViewLandscape: View {
    ...
    var body: some View {
        ...
        if multiLine == false {
           ...
           LineView2(data: GraphData, title: GraphTitle, style: selectedGraphStyle )
            ...
            //.frame(width: 400, height: 410) // Must Be Same as Set in LineView2 Class
...
struct GraphViewLandscape_Previews: PreviewProvider {
