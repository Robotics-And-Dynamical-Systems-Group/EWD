...
class TopGraphViewController: UIViewController {
    
    var chartView = LineChartView()
    var dataPoints = Array(repeating: 0, count: topDataPointSize)
    var dataPointSelector = 1

    override func viewDidLoad() {
        super.viewDidLoad()

        self.primeDataPoints()
        self.setupLineChart(dataPoints: dataPoints, values: heartRatePPG)
    ...
    func primeDataPoints(){
        dataPoints = Array(repeating: 0, count: topDataPointSize)
