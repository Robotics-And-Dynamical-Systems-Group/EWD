//
//  PPP_GraphVCViewController.swift
//  ePoD
//
//  Created by Tyler Goudie on 3/18/20.
...
class PPG_GraphVCViewController: UIViewController {

    var chartView = LineChartView()
    var dataPoints = Array(repeating: 0, count: heartRatePPG.count)
    ...
    override func viewDidLoad() {
        ...
        self.updateChartData(dataPoints: dataPoints, values: heartRatePPG)
